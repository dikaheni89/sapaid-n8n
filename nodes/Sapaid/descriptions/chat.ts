...
export const chatFields: INodeProperties[] = [
  idField(
    'chat',
    ['assign', 'close', 'get', 'listMessages', 'markRead', 'reopen', 'setLabels'],
    'chatId',
    'Chat ID',
    'The ID of the chat',
  ),
  {
    ...
    default: '',
    description:
      'The team member to assign. Leave empty to unassign. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
  ...
  },
  {
    ...
    default: [],
    description:
      'The labels the chat should carry; any label not listed is removed. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    displayOptions: { show: { resource: ['chat'], operation: ['setLabels'] } },
  },
  ...listPagination('chat', ['list', 'listMessages']),
  {
    displayName: 'Filters',
    name: 'filters',
    type: 'collection',
