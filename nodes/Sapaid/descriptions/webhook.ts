  ...
  options: [
    {
      ...
      description:
        'Register a URL to receive events. For n8n itself, use the sapaid Trigger node instead.',
    },
    {
      name: 'Delete',
      value: 'delete',
...
const SECRET_DESCRIPTION =
  'Shared secret of 16 to 255 characters. When set, every delivery carries an X-Sapaid-Signature header (HMAC-SHA256 of the raw body) the receiver can verify.';
