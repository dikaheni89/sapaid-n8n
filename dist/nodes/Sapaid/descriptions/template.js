...
exports.templateFields = [
    (0, common_1.idField)('template', ['delete', 'get', 'render', 'update'], 'templateId', 'Template ID', 'The ID of the template'),
    {
        displayName: 'Name',
        name: 'name',
        type: 'string',
    ...
    },
    {
        ...
        default: '',
        required: true,
        description: 'Message text with placeholders written as {{name}}, e.g. "Halo {{nama}}, pesanan {{order_id}} sudah dikirim."',
        displayOptions: { show: { resource: ['template'], operation: ['create'] } },
    },
    {
    ...
    ...(0, common_1.listPagination)('template', ['list']),
];
