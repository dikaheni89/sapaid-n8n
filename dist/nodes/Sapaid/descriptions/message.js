...
exports.messageFields = exports.messageOperations = exports.MEDIA_SEND_OPERATIONS = void 0;
const common_1 = require("./common");
exports.MEDIA_SEND_OPERATIONS = [
    'sendAudio',
    'sendDocument',
    'sendImage',
    'sendSticker',
...
exports.messageFields = [
    // ---- shared by every send ----
    {
        ...
        description: 'Recipient phone number in international form without + (a leading 0 is read as Indonesia, so 0812… becomes 62812…), or a chat/group ID from a previous node',
        displayOptions: { show: { resource: ['message'], operation: SEND_OPERATIONS } },
    },
    (0, common_1.numberSelector)('message', SEND_OPERATIONS),
    // ---- sendText ----
    {
        displayName: 'Text',
        name: 'text',
        ...
        default: '',
        required: true,
        description: 'The message text. WhatsApp formatting works: *bold*, _italic_, ~strike~, ```mono```.',
    ...
    // ---- media sends ----
    {
        ...
        displayOptions: { show: { resource: ['message'], operation: exports.MEDIA_SEND_OPERATIONS } },
    },
    {
        ...
        displayOptions: {
            show: { resource: ['message'], operation: exports.MEDIA_SEND_OPERATIONS, mediaSource: ['binary'] },
        },
    },
    {
        ...
        displayOptions: {
            show: { resource: ['message'], operation: exports.MEDIA_SEND_OPERATIONS, mediaSource: ['url'] },
        },
    },
    {
        ...
        displayOptions: {
            show: { resource: ['message'], operation: exports.MEDIA_SEND_OPERATIONS, mediaSource: ['base64'] },
        },
    },
    {
        ...
        description: 'MIME type of the base64 data. Leave empty to use the default for this kind of media.',
        displayOptions: {
            show: { resource: ['message'], operation: exports.MEDIA_SEND_OPERATIONS, mediaSource: ['base64'] },
        },
    },
    ...
    },
    {
        ...
        type: 'boolean',
        default: false,
        description: 'Whether to deliver the audio as a push-to-talk voice note instead of an audio file. Voice notes should be OGG/Opus.',
    ...
    // ---- sendTemplate ----
    {
        ...
        default: '',
        required: true,
        description: 'The saved template to send. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    ...
    },
    {
        ...
        type: 'json',
        default: '{}',
        description: 'Values for the template placeholders as a JSON object, e.g. <code>{"nama": "Budi", "order_id": "A123"}</code>',
        displayOptions: { show: { resource: ['message'], operation: ['sendTemplate'] } },
    },
    // ---- send options ----
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'string',
                default: '',
                description: 'A unique key for this send. Repeating a request with the same key within 24 hours returns the first result instead of sending twice, which makes a retried workflow safe.',
            },
            {
                ...
                default: 0,
                description: 'Show a typing indicator for this long before the message goes out. Helps a bot look less like a bot.',
            },
        ],
    },
    // ---- get / downloadMedia ----
    (0, common_1.idField)('message', ['get', 'downloadMedia'], 'messageId', 'Message ID', 'The ID of the message'),
    {
    ...
    // ---- list ----
    ...(0, common_1.listPagination)('message', ['list']),
    {
        displayName: 'Filters',
        name: 'filters',
        type: 'collection',
