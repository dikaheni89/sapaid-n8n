...
exports.broadcastFields = exports.broadcastOperations = void 0;
const common_1 = require("./common");
exports.broadcastOperations = {
...
exports.broadcastFields = [
    (0, common_1.idField)('broadcast', ['cancel', 'get'], 'broadcastId', 'Broadcast ID', 'The ID of the broadcast'),
    {
        displayName: 'Name',
        name: 'name',
        type: 'string',
    ...
    (0, common_1.numberSelector)('broadcast', ['create']),
    {
        ...
        default: '',
        required: true,
        description: 'Phone numbers to send to, comma- or newline-separated, or a JSON array from an expression. Each is normalised like the To field of a send.',
        displayOptions: { show: { resource: ['broadcast'], operation: ['create'] } },
    },
    {
        displayName: 'Content',
    ...
    },
    {
        ...
        default: '',
        required: true,
        description: 'The template to send. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
        displayOptions: {
    ...
    },
    {
        ...
        type: 'json',
        default: '{}',
        description: 'Placeholder values shared by every recipient as a JSON object. Per-recipient values are filled from the contact (e.g. {{nama}}).',
        displayOptions: {
            show: { resource: ['broadcast'], operation: ['create'], contentType: ['template'] },
        },
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                default: 5,
                description: 'Pause between recipients. A slower pace keeps a number safer; the server enforces a floor per plan.',
            },
        ],
    },
    ...(0, common_1.listPagination)('broadcast', ['list']),
    {
        displayName: 'Filters',
        name: 'filters',
        type: 'collection',
